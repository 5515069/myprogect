...
var RequestData = function (showLoading) {
   ...
   // alert(GLOBAL_VAR.time_type);
    ...
    if (size > 0) { 
    	...
    	var bollcycle = document.getElementById('bollcycle').value; 
    	var bollwidth = document.getElementById('bollwidth').value;
    	var profitlevel = document.getElementById('profitlevel').value;
    	var openopeninterest = document.getElementById('openopeninterest').value;
    	var closeopeninterest = document.getElementById('closeopeninterest').value;
    	var forwarddays= document.getElementById('forwarddays').value;
    	var arr = new Array();            //先声明一维 
    	 $.ajax({
   		  url:'http://localhost:8080/Sys/getbollshock2',
   	      data:{'cycle':GLOBAL_VAR.time_type,'bollcycle':bollcycle,'bollwidth':bollwidth,'profitlevel':profitlevel
   	    	  ,'openopeninterest':openopeninterest,'closeopeninterest':closeopeninterest,'forwarddays':forwarddays},
   		  type:'POST',
