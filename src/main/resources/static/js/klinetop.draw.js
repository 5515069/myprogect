...
var RequestData = function (showLoading) {
   ...
   // alert(GLOBAL_VAR.time_type);
    ...
    if (size > 0) { 
    	...
    	var openPosition = document.getElementById('openPosition').value;
    	var closePosition = document.getElementById('closePosition').value; 
    	...
    	var arr = new Array();            //先声明一维 
    	 $.ajax({
   		  url:'http://localhost:8080/Sys/getIndexs',
   	      data:{'cycle':GLOBAL_VAR.time_type,'profitlevel':profitlevel,'openPosition':openPosition,
   	    	  'closePosition':closePosition,'openopeninterest':openopeninterest,'closeopeninterest':closeopeninterest,
   	    	  'closeDate':closeDate},
   		  type:'POST',
