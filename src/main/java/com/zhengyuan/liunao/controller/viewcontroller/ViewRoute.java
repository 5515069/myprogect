...
public class ViewRoute {
	...
	@RequestMapping("/klinetop")
	public String klinetop() {
		return "klinetop";
	}
	@RequestMapping("/klinetopreverse")
	public String klinetopreverse() {
		return "klinetopreverse";
	}
	@RequestMapping("/klineaverage")
	public String klineaverage() {
		return "klineaverage";
	}
	@RequestMapping("/klineboll")
	public String klineboll() {
		return "klineboll";
	}
	@RequestMapping("/klineboll2")
	public String klineboll2() {
		return "klineboll2";
	}
	@RequestMapping("/klinebollshock")
	public String klinebollshock() {
		return "klinebollshock";
	}
	@RequestMapping("/klinebollshock2")
	public String klinebollshock2() {
		return "klinebollshock2";
	}
	@RequestMapping("/klineindexs")
	public String klineindexs() {
		return "klineindexs";
	}
	@RequestMapping("/klinefunction")
	public String klinefunction() {
		return "klinefunction";
	}
	@RequestMapping("/klineoddsanddata")
	public String klineoddsanddata() {
		return "klineoddsanddata";
	}
	@RequestMapping("/klinedata")
	public String klinedata() {
		return "klinedata";
	}
}
