...
@Slf4j
public class klineindexsController {
	...
	@RequestMapping(value = "/getfutureindexs")
	@ResponseBody
	public String getfutureindexs(@RequestParam("cycle") String cycle, @RequestParam("kind1value") String kind1value,
